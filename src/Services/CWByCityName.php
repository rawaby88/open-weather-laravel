...
class CWByCityName extends WeatherFactory implements CWSingleResultInterface
{
	 ...
	 */
	public
	function __construct( string $cityName, string $countryCode = null, string $stateCode = null )
	{
		parent::__construct();
	...
	: array
	{
		...
		if ( $this->stateCode ) $q .= ',' . $this->stateCode;
		if ( $this->countryCode ) $q .= ',' . $this->countryCode;
