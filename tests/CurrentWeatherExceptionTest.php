 ...
 * @package Rawaby88\OpenWeatherMap\Test
 */
class CurrentWeatherExceptionTest extends TestCase
{
	...
	/** @test */
	public
	function it_through_an_exception_empty_api_key()
	{
	...
	/** @test */
	public
	function it_through_an_exception_not_found_with_wrong_city_name()
	{
	...
	/** @test */
	public
	function it_through_an_exception_not_found_with_empty_city_name()
	{
		$this->expectException( NotFoundException::class );
		$cw = new CWByCityName( '' );
		$cw->get();
	...
	/** @test */
	public
	function it_through_an_exception_not_found_with_wrong_country_code()
	{
		$this->expectException( NotFoundException::class );
	...
	/** @test */
	public
	function it_through_an_exception_not_found_with_wrong_state_code()
	{
		$this->expectException( NotFoundException::class );
