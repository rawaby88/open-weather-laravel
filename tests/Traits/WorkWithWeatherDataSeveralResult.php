...
trait WorkWithWeatherDataSeveralResult
{
    public function mockSeveralWeatherResponse(): Response
    {
        return new Response(
            200, [], json_encode(
                   [
    ...
    /** @test */
    public function it_return_location_sun_weather_and_temperature_objects()
    {
        $this->initCall();
    ...
    /** @test */
    public function it_return_location_coordinates()
    {
        $this->initCall();
    ...
    /** @test */
    public function it_return_location_country_code()
    {
        $this->initCall();
    ...
    /** @test */
    public function it_return_location_json()
    {
        $this->initCall();
        $json = json_encode(
            [
    ...
    /** @test */
    public function it_return_sun_sunset_date_time()
    {
        $this->initCall();
    ...
    /** @test */
    public function it_return_sun_sunrise_date_time()
    {
        $this->initCall();
        $sun = $this->getCurrentWeather->sun;
    ...
    /** @test */
    public function it_return_sun_json()
    {
        $this->initCall();
    ...
    /** @test */
    public function it_return_temperature_rounded_values()
    {
        $this->initCall();
    ...
    /** @test */
    public function it_return_temperature_json()
    {
        $this->initCall();
    ...
    /** @test */
    public function it_return_weather_icon()
    {
        $this->initCall();
    ...
    /** @test */
    public function it_return_weather_wind()
    {
        $this->initCall();
        $weather = $this->getCurrentWeather->weather;
    ...
    /** @test */
    public function it_return_weather_condition_description()
    {
        $this->initCall();
        $weather = $this->getCurrentWeather->weather;
    ...
    /** @test */
    public function it_return_weather_clouds()
    {
        $this->initCall();
        $weather = $this->getCurrentWeather->weather;
    ...
    /** @test */
    public function it_return_weather_precipitation_and_snow_volume()
    {
        $this->initCall();
        $weather = $this->getCurrentWeather->weather;
    ...
    /** @test */
    public function it_return_weather_json()
    {
        $this->initCall();
    ...
    /** @test */
    public function it_return_units()
    {
        $this->initCall();
    ...
    /** @test */
    public function it_return_numbers_of_results()
    {
        $this->mockHandler->append($this->mockSeveralWeatherResponse());

        $this->getCurrentWeather = $this->cw->get();

        $this->assertEquals(2, $this->getCurrentWeather->count());
    }

    public function it_return_provided_index()
    {
        $this->mockHandler->append($this->mockSeveralWeatherResponse());

        $this->getCurrentWeather = $this->cw->get()->index(0);
